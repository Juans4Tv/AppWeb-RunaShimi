...
const Registrar = ({ onGoToLogin }) => {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        setSuccess('¡Registro exitoso! Se ha enviado un correo a ' + email);
        setTimeout(() => {
          onGoToLogin();
        }, 3000);
      } else {
          ...
          <form style={styles.form} onSubmit={handleRegister}>
            ...
            <div style={styles.inputGroup}>
              ...
              <div style={styles.eyeIconWrapper} onClick={() => setMostrarContrasena(!mostrarContrasena)}>
                {mostrarContrasena ? <EyeOff size={18} color="#5D4037" /> : <Eye size={18} color="#5D4037" />}
              </div>
            </div>

            <p style={styles.passwordHint}>
              La contraseña debe tener un mínimo de 8 caracteres, una mayúscula, un número y un carácter especial.
            </p>
